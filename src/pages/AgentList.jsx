...
function AgentList() {
  return (
    <div className="flex flex-col min-h-screen gradient-bg">
      <Header />
      <div className="container flex-grow mx-auto grid grid-cols-12 gap-4 mt-40 w-full">
        {/* Sidebar */}
        <div className="col-span-2 rounded-xl md:rounded-none relative overflow-hidden">
          <Sidebar />
        </div>
